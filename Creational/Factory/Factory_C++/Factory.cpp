...
class Spider : public IAnimal // Spider is not really an animal.
{
	public:
...
// Create function pointer (use __stdcall calling convention)
...
// Though the registration doesn’t have to be done here. It is done here for the purpose of this example. 
...
int main( int argc, char **argv )
{
	...
	while( pAnimal == NULL )
	{
		...
		{
			cout << "That animal does not exist in the farm! Please choose another!" << endl;
		}
